...
import { callFetchExercise } from "@/config/api";
...
export const fetchExercise = createAsyncThunk(
    ...
    async ({ query }: { query: string }) => {
        const response = await callFetchExercise(query);
        return response;
    }
);
...
export const exerciseSlide = createSlice({
    name: "exercise",
    initialState,
...
export const { setActiveMenu } = exerciseSlide.actions;

export default exerciseSlide.reducer;
