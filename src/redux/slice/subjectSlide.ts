...
import { callFetchGrade, callFetchSubject } from "@/config/api";
import { IGrade, ISubject } from "@/types/backend";
...
export const fetchSubject = createAsyncThunk(
    ...
    async ({ query }: { query: string }) => {
        const response = await callFetchSubject(query);
        return response;
    }
);
...
export const subjectSlide = createSlice({
    name: "subject",
    initialState,
...
export const { setActiveMenu } = subjectSlide.actions;
