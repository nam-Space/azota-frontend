...
const StartingTest = () => {
    ...
    useEffect(() => {
        if (router.query.testId && router.query.classroomExerciseId) {
        ...
        <div >
            <div className={styles['container']}>
                        ...
                        <div id={(index + 1) + ''} key={index + 1} className={styles['question-item']}>
                            <div style={{ padding: 20 }}>
                                ...
                                <div style={{ marginTop: 10 }}>
                                    <p style={{ fontWeight: 600 }}>
                                        <FormattedMessage id="student-classroomDetail-testDetail-startingDetail.left-container.question" /> {index + 1}:
                                    </p>
                            ...
                            <div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 20, background: theme, color: 'white', padding: 6 }}>
                                    <p style={{ fontWeight: 600 }}><FormattedMessage id="student-classroomDetail-testDetail-startingDetail.left-container.your-answer" /></p>
                ...
                <div className={styles['right-container']}>
                    <p style={{ fontWeight: 600, textAlign: 'left' }}><FormattedMessage id="student-classroomDetail-testDetail-startingDetail.right-container.title" /></p>
                    ...
                    <div style={{ marginTop: 20, display: 'flex', gap: 6, justifyContent: 'center', alignItems: 'center' }}>
                        <FormattedMessage id="student-classroomDetail-testDetail-startingDetail.right-container.time-remaining" />
                    ...
                    <Button onClick={() => setIsModalOpen(true)} style={{ marginTop: 20, background: theme }} type='primary' icon={<FormOutlined />}>
                        <span>
                            <FormattedMessage id="student-classroomDetail-testDetail-startingDetail.right-container.submit.title" />
                        </span>
                    </Button>
                </div>
            </div>
            <ModalForm
                title={<FormattedMessage id="student-classroomDetail-testDetail-startingDetail.right-container.submit.modal.title" />}
                open={isModalOpen}
                modalProps={{
                ...
                submitter={{
                    ...
                    searchConfig: {
                        resetText: <span><FormattedMessage id="student-classroomDetail-testDetail-startingDetail.right-container.submit.modal.cancel" /></span>,
                        submitText: <span><FormattedMessage id="student-classroomDetail-testDetail-startingDetail.right-container.submit.modal.submit" /></span>,
                    }
                }}
            >
            </ModalForm >
